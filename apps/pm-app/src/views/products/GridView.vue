  ...
  <div class="p-8 h-full relative pb-24 overflow-y-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
      <Card
        ...
        :key="product.id"
        class="flex flex-col overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group cursor-pointer bg-white"
      >
          ...
          <div class="p-4 flex flex-col gap-2">
              ...
              <p class="text-blue-600 font-semibold">{{ formatPrice(product.price) }}</p>
          </div>
      </Card>
    </div>
